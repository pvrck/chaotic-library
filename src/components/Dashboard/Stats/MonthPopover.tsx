...
export const MonthPopover = ({
  ...
  return (
    <Menu as="div" className="relative">
      <MenuButton className="px-6 py-2 bg-white border border-slate-200 rounded-full font-bold text-sm shadow-sm hover:bg-slate-50">
        {months[selectedMonth]} ▼
      </MenuButton>
      <MenuItems className="absolute left-0 mt-2 w-40 bg-white rounded-xl shadow-xl border border-slate-100 p-1 z-10">
